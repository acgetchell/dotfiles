...
brew "git-lfs"                         # Git Large File Storage support
...
brew "llvm"                            # LLVM/Clang compiler toolchain
...
cask "lycheeslicer"                   # resin 3D printer slicer
cask "mactex"                         # TeX/LaTeX distribution
cask "microsoft-teams"                # Microsoft Teams collaboration app
cask "notion"                         # Notion workspace app
